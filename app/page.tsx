  ...
  return (
    ...
    >
      <a
        ...
        className="flex bg-[#003f91e4] w-[130px] rounded-md items-center justify-center p-2 md:mr-2 md:my-2"
        target="_blank"
      >
        <BsGithub />
      ...
      <a
        ...
        className="flex bg-[#003f91e4] w-[130px] rounded-md items-center justify-center space-x-2 p-2 my-2 md:m-2"
        target="_blank"
      >
        <AiOutlineLinkedin />
        <div className="flex-grow" />
      ...
      <a
        ...
        className="flex bg-[#003f91e4] w-[130px] rounded-md items-center justify-center space-x-2 p-2 md:my-2 md:ml-2"
